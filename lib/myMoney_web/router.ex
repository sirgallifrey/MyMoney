defmodule MyMoneyWeb.Router do
  ...
  if Application.compile_env(:myMoney, :dev_routes) do
  ...
  scope "/", MyMoneyWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{MyMoneyWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", MyMoneyWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{MyMoneyWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", MyMoneyWeb do
    ...
    live_session :current_user,
      on_mount: [{MyMoneyWeb.UserAuth, :mount_current_user}] do
